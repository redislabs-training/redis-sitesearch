...
def test_indexer_indexes_page_document(index_file, keys, site):
    ...
    # If this test is failing, use this print statement to print out the
    # body text that you need to paste into this test. (This happens if
    # (you change the text of a fixture file...)
    if expected_doc != call[1]['mapping']:
...
def test_indexer_indexes_page_section_documents(index_file, keys, site):
    ...
    expected_section_docs = [{
        ...
        'doc_id': f'{TEST_URL}:section:9cc345ed21dec166694ef55243858189',
        'title': 'Database Persistence with Redis Enterprise Software',
...
def test_indexer_indexes_sections_from_h3s(index_file, keys, site):
    ...
    for i, doc in enumerate(expected_section_docs, start=1):
        ...
        # (you change the text of a fixture file...)
        #
        # NOTE: The value 1 here should be the number of the document that is
        # failing in the test.
        #
        # print(call[1]['mapping']['body'])
        assert call[0][0] == key
